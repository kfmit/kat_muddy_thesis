...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Originals, Preserve stuff}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{center}
  \begin{minipage}{0.5\textwidth}
    \begin{small}
      ...
      whole world to see and we encounter some usage guidelines. I suppose this could be a quote about how ice has changed?
    \end{small}
  \end{minipage}
  \vspace{0.5cm}
\end{center}
...
I was not satisfied with the available templates for \LaTeX{} and wanted to heed the style advice given by people such as Robert
Bringhurst~\autocite{Bringhurst12} or Edward R.\ Tufte~\autocite{Tufte90,Tufte01}. While there \emph{are} some packages out there that attempt to emulate these styles, I found them to be either too bloated, too playful, or too constraining. This template attempts to
produce a beautiful look without having to resort to any sort of hacks.
I hope you like it.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Noise in the Arctic}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}
\centering
\includegraphics[width=.5in]{Figures/Average_ANL2.jpg}
\caption{This is my test Boi.}
\label{fig_avganl}
\end{figure}
